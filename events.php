                ...
                <div class="breadcrumbs-container container">
                    <div class="breadcrumbs_wrapper">
                        <div class="page-title-container">
                            <h1 class="text-center">Events & Awards</h1>
                        </div>
                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12 gallery-item clearfix m-bottom-30">
                            <div class="gallery-item-inner clearfix animated">
                                <div class="entry-thumbnail">
                                    <div class="entry-thumbnail-overlay placeholder-image img5"  title="Asian Grilled Chicken Salad"></div>
                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body fadeInDownBig">
                                            <img src="img/awards/award1.jpeg" alt="" class="w-100">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 gallery-item clearfix m-bottom-30">
                            <div class="gallery-item-inner clearfix animated">
                                <div class="entry-thumbnail">
                                    <div class="entry-thumbnail-overlay placeholder-image img6" title=""></div>
                                </div>
                            ...
                            <div class="modal fadeIn zoomIn animated" id="myModal1" data-animate="zoomIn" data-delay="50">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body fadeInDownBig">
                                            <img src="img/awards/award2.jpeg" alt="" class="w-100">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 gallery-item clearfix m-bottom-30">
                            <div class="gallery-item-inner clearfix animated">
                                <div class="entry-thumbnail">
                                    <div class="entry-thumbnail-overlay placeholder-image img7" title="Fruits And Beans Veggie Salad"></div>
                                </div>
                            ...
                            <div class="modal fadeIn zoomIn animated" id="myModal2" data-animate="zoomIn" data-delay="50">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body fadeInDownBig">
                                            <img src="img/awards/award3.jpeg" alt="" class="w-100">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 gallery-item clearfix m-bottom-30">
                            <div class="gallery-item-inner clearfix animated">
                                ...
                                <div class="gallery-content">
                                    <div class="gallery-action" data-toggle="modal" data-target="#myModal3">
                                        <a href="#" class="gsf-link">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                            ...
                            <!-- Modal -->
                            <div class="modal fadeIn zoomIn animated" id="myModal3" data-animate="zoomIn" data-delay="50">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="close" data-dismiss="modal">
                                            <i class="float-right" aria-hidden="true">×</i>
                                        ...
                                        <div class="modal-body fadeInDownBig">
                                            <img src="img/awards/award4.jpeg" alt="" class="w-100">
                                        </div>
                                    </div>
                                </div>
                            </div>
